...
class CaptureManager(object):
    ...
    def exitFrame(self):
        #draw the window, write to files, release the krak.. ehhhh I mean frame
        #check wether any grabbed frame is retrievable
        ...
        if self.isWritingImage:
            cv2.imwrite(self._imageFilename, numpy.fliplr(self._frame))
            self._imageFilename = None
